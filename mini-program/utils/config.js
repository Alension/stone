...
var DOMAIN = "http://192.168.1.20:8090";
var MINAPPTYPE = "1";//小程序的类型，如果是企业小程序请填：0 ，如果是个人小程序请填：1
var WEBSITENAME = "Alension"; //网站名称
var ABOUTID = 13; //wordpress网站"页面"的id,注意这个"页面"是wordpress的"页面"，不是"文章"
...
var POSTERIMGURL = "../../images/youhui.png"; //生成海报如果没有首图，使用此处设置的图片作为海报图片。
