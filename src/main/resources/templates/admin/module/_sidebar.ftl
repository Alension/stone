  ...
  <section class="sidebar">
    <div class="user-panel">
      <div class="pull-left image">
        <img
            src="<#if user.userAvatar?if_exists!="">${user.userAvatar!}<#else >/static/halo-backend/images/default.png</#if>"
            class="img-circle" alt="User Image">
      </div>
      <div class="pull-left info">
        <p>${user.userDisplayName!}</p><a data-pjax="true" href="/admin/profile"><i
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu" style="">
          <li><a data-pjax="true" href="/admin/posts"><i
              class="fa fa-circle-o"></i><@spring.message code='admin.menu.all-posts' /></a></li>
          <li><a data-pjax="true" href="/admin/posts/write"><i
              class="fa fa-circle-o"></i><@spring.message code='admin.menu.new-post' /></a></li>
          <li><a data-pjax="true" href="/admin/category"><i
              class="fa fa-circle-o"></i><@spring.message code='admin.menu.categories' /></a></li>
          <li><a data-pjax="true" href="/admin/tag"><i
              class="fa fa-circle-o"></i><@spring.message code='admin.menu.tags' /></a></li>
        </ul>
      </li>
      <li class="treeview">
        <a data-pjax="true" href="javascript:void(0)">
        ...
        <ul class="treeview-menu">
          ...
          <li><a data-pjax="true" href="/admin/page/new"><i
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a data-pjax="true" href="/admin/profile"><i
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a data-pjax="true" href="/admin/option"><i
              class="fa fa-circle-o"></i><@spring.message code='admin.menu.blog-settings' /></a>
          </li>
